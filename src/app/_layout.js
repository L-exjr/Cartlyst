...
const COUNTRY_TO_CURRENCY = {
  US: 'USD', CA: 'CAD', GB: 'GBP', FR: 'EUR', DE: 'EUR', ES: 'EUR', IT: 'EUR', NG: 'NGN', KE: 'KES', ZA: 'ZAR', IN: 'INR', CN: 'CNY', JP: 'JPY', KR: 'KRW', RU: 'RUB', BR: 'BRL', MX: 'MXN', EG: 'EGP', SA: 'SAR', AE: 'AED', // ...add more as needed
};
const COUNTRY_TO_LANGUAGE = {
  US: 'en', GB: 'en', FR: 'fr', DE: 'de', ES: 'es', IT: 'it', NG: 'en', KE: 'sw', ZA: 'en', IN: 'hi', CN: 'zh', JP: 'ja', KR: 'ko', RU: 'ru', BR: 'pt', MX: 'es', EG: 'ar', SA: 'ar', AE: 'ar', // ...add more as needed
};
